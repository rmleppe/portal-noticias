    ...
    <div className={"col-md-12 form-wrapper"}> <br />
      ...
      {!submitSuccess && (
        <div className="alert alert-info" role="alert">
          Rellene el formulario para crear un nuevo post
                </div>
      )}
      {submitSuccess && (
        <div className="alert alert-info" role="alert">
          Post correctamente creado
                        </div>
      )}
      <form id={"create-post-form"} onSubmit={handleFormSubmission} noValidate={true}>
        <div className="form-group col-md-12">
          <label htmlFor="title"> Título </label>
          <input type="text" id="title" onChange={(e) => handleInputChanges(e)} name="title" className="form-control" placeholder="Ingrese titulo" />
        </div>
        <div className="form-group col-md-12">
          <label htmlFor="description"> Descripción </label>
          <input type="text" id="description" onChange={(e) => handleInputChanges(e)} name="description" className="form-control" placeholder="Ingrese descripción" />
        </div>
        <div className="form-group col-md-12">
